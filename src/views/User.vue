<script setup>
// 导入自定义的js
import { userGetAllService, userUpdateService, userAddService, userDeleteService, userSelectService, userDeleteByIdsService } from '../api/user.js'
        ...
        <template #header>
            ...
            <div class="box">
                ...
                <el-button type="danger" :icon="Delete" :disabled="tableChecked.length === 0"
                    @click="deleteByIdsUser(tableChecked)">批量删除用户</el-button>
            </div>
        </template>
